                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('contacts.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input name="relevant_project_programme" class="border rounded w-full" value="{{ old('relevant_project_programme') }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input name="stakeholder_type" class="border rounded w-full" value="{{ old('stakeholder_type') }}">
                        </div>

                        <div>
                            <label class="block font-medium">Comment</label>
                            <textarea name="comment" class="border rounded w-full" rows="4">{{ old('comment') }}</textarea>
                        </div>
